package pojos.pojosOpenWeather;


import java.util.List;

public class PojoOWeather {
    ...
    public PojoOWeather(Coord coord, List<Weather> weather, String base, Main main, Integer visibility, Wind wind, Clouds clouds, Integer dt, Sys sys, Integer timezone, Integer id, String name, Integer cod) {
        super();
        this.coord = coord;
    ...
    public String toString() {
        ...
        sb.append(PojoOWeather.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("coord");
        sb.append('=');
